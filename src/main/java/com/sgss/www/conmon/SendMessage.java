...
//替换成你的AK
        final String accessKeyId = PropKit.get("d.accessKeyId");//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = PropKit.get("d.accessKeySecret");//你的accessKeySecret，参考本文档步骤2
//初始化ascClient,暂时不支持多region（请勿修改）
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName(PropKit.get("d.SignName"));
